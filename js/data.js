...
PR.stores = [
  // Perú
  { id: 'mercadolibre', name: 'Mercado Libre',  icon: '🤝', rating: 4.5, color: '#FFE600', country: 'pe', url: 'https://www.mercadolibre.com.pe',  searchUrl: 'https://listado.mercadolibre.com.pe/{query}',              affiliateParam: 'aff=pricereview',          affiliateEnabled: true },
  { id: 'falabella',    name: 'Falabella',      icon: '🏢', rating: 4.2, color: '#AAD500', country: 'pe', url: 'https://www.falabella.com.pe',    searchUrl: 'https://www.falabella.com.pe/search?Ntt={query}',          affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'ripley',       name: 'Ripley',         icon: '🏬', rating: 4.0, color: '#8B1A8E', country: 'pe', url: 'https://simple.ripley.com.pe',    searchUrl: 'https://simple.ripley.com.pe/search?q={query}',            affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'oechsle',      name: 'Oechsle',        icon: '🏪', rating: 3.8, color: '#E31837', country: 'pe', url: 'https://www.oechsle.pe',          searchUrl: 'https://www.oechsle.pe/search?q={query}',                  affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'plazavea',     name: 'PlazaVea',       icon: '🛒', rating: 3.7, color: '#00A650', country: 'pe', url: 'https://www.plazavea.com.pe',     searchUrl: 'https://www.plazavea.com.pe/search?_query={query}',        affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'hiraoka',      name: 'Hiraoka',        icon: '📺', rating: 3.9, color: '#D4001A', country: 'pe', url: 'https://hiraoka.com.pe',           searchUrl: 'https://hiraoka.com.pe/catalogsearch/result/?q={query}',   affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'coolbox',      name: 'CoolBox',        icon: '🎮', rating: 3.8, color: '#00B4D8', country: 'pe', url: 'https://www.coolbox.pe',           searchUrl: 'https://www.coolbox.pe/search?q={query}',                  affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'promart',      name: 'Promart',        icon: '🔨', rating: 3.8, color: '#E8308C', country: 'pe', url: 'https://www.promart.pe',           searchUrl: 'https://www.promart.pe/search?q={query}',                  affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'sodimac',      name: 'Sodimac',        icon: '🏗️', rating: 3.9, color: '#FF6900', country: 'pe', url: 'https://www.sodimac.com.pe',      searchUrl: 'https://www.sodimac.com.pe/search?q={query}',              affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'linio',        name: 'Linio',          icon: '🛍️', rating: 3.6, color: '#FF6600', country: 'pe', url: 'https://www.linio.com.pe',        searchUrl: 'https://www.linio.com.pe/search?scroll=&q={query}',        affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'curacao',      name: 'La Curacao',     icon: '🏠', rating: 3.7, color: '#003DA5', country: 'pe', url: 'https://www.lacuracao.pe',         searchUrl: 'https://www.lacuracao.pe/curacao/buscador?query={query}',   affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'metro',        name: 'Metro',          icon: '🛒', rating: 3.6, color: '#003399', country: 'pe', url: 'https://www.metro.pe',             searchUrl: 'https://www.metro.pe/search?_query={query}',               affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'wong',         name: 'Wong',           icon: '🛒', rating: 3.7, color: '#D4001A', country: 'pe', url: 'https://www.wong.pe',              searchUrl: 'https://www.wong.pe/search?_query={query}',                affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'phantom',      name: 'Phantom',        icon: '🖥️', rating: 3.8, color: '#7B2D8E', country: 'pe', url: 'https://www.phantom.com.pe',      searchUrl: 'https://www.phantom.com.pe/search?q={query}',              affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  // Colombia
  { id: 'exito',        name: 'Éxito',          icon: '🏬', rating: 4.0, color: '#FFDD00', country: 'co', url: 'https://www.exito.com',            searchUrl: 'https://www.exito.com/s?q={query}',                        affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'alkosto',      name: 'Alkosto',        icon: '🏪', rating: 3.9, color: '#E31837', country: 'co', url: 'https://www.alkosto.com',          searchUrl: 'https://www.alkosto.com/search?q={query}',                 affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  // México
  { id: 'liverpool',    name: 'Liverpool',      icon: '🏬', rating: 4.1, color: '#E91E8C', country: 'mx', url: 'https://www.liverpool.com.mx',     searchUrl: 'https://www.liverpool.com.mx/tienda?s={query}',            affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'coppel',       name: 'Coppel',         icon: '🏪', rating: 3.8, color: '#0033A0', country: 'mx', url: 'https://www.coppel.com',           searchUrl: 'https://www.coppel.com/search?q={query}',                  affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  // Chile
  { id: 'lider',        name: 'Lider',          icon: '🛒', rating: 3.8, color: '#0033A0', country: 'cl', url: 'https://www.lider.cl',             searchUrl: 'https://www.lider.cl/catalogo?search={query}',             affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  { id: 'paris',        name: 'Paris',          icon: '🏢', rating: 3.9, color: '#1A1A1A', country: 'cl', url: 'https://www.paris.cl',             searchUrl: 'https://www.paris.cl/search?q={query}',                    affiliateParam: 'utm_source=pricereview',   affiliateEnabled: false },
  // Internacional
  { id: 'amazon',       name: 'Amazon',         icon: '📦', rating: 4.8, color: '#FF9900', country: 'global', url: 'https://www.amazon.com',           searchUrl: 'https://www.amazon.com/s?k={query}',                       affiliateParam: 'tag=pricereview-20',       affiliateEnabled: true },
  { id: 'ebay',         name: 'eBay',           icon: '🏷️', rating: 4.0, color: '#E53238', country: 'global', url: 'https://www.ebay.com',             searchUrl: 'https://www.ebay.com/sch/i.html?_nkw={query}',             affiliateParam: 'mkrid=711-53200-19255-0',  affiliateEnabled: true },
  { id: 'aliexpress',   name: 'AliExpress',     icon: '🌐', rating: 3.5, color: '#FF4747', country: 'global', url: 'https://es.aliexpress.com',        searchUrl: 'https://es.aliexpress.com/wholesale?SearchText={query}',   affiliateParam: 'aff_id=pricereview',       affiliateEnabled: true },
];
...
PR.initCurrency = function(callback) {
  ...
  // Set the search country based on user preference or auto-detected country
  var savedSearchCountry = localStorage.getItem('PR_SEARCH_COUNTRY');
  PR.searchCountry = savedSearchCountry ? savedSearchCountry : PR.currency.country;
